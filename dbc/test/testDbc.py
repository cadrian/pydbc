#  pyDBC: design by contract in Python
#  Copyright (C) 2011 Cyril ADRIAN <cyril.adrian@gmail.com>
#
...
from dbc import ContractException, ContractObject, invariant, require, ensure
...
class B(A):
    ...
    @ensure(definition="__result__ == self.x")
    def getx(self):
        return self.x
